            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                        ...
                        <select class="form-control form_select_cof form-select" name="ruxsatnoma_turi_id"
                            ...
                            @foreach ($ruxsatnoma_turi as $rux_tur)
                                <option value="{{ $rux_tur->id }}"
                                    {{ old('ruxsatnoma_turi_id') == $rux_tur->id ? 'selected' : '' }}>
                                    {{ $rux_tur->name }}
                                </option>
                            @endforeach
                        </select>
                        @error('ruxsatnoma_turi_id')
                            <span class="error invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control form_select_cof form-select" name="ruxsatnoma_kim_tamonidan_id"
                            id="ruxsatnoma_kim_tamonidan_id">
                            <option value="">Танланг</option>
                            @foreach ($ruxsatnoma_kim_tamonidan as $rux_kim)
                                <option value="{{ $rux_kim->id }}"
                                    {{ old('ruxsatnoma_kim_tamonidan_id') == $rux_kim->id ? 'selected' : '' }}>
                                    {{ $rux_kim->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control form_select_cof form-select" name="ruxsatnoma_berilgan_ish_turi_id"
                            id="ruxsatnoma_berilgan_ish_turi_id">
                            <option value="">Танланг</option>
                            @foreach ($ruxsatnoma_berilgan_ish_turi as $rux_ber)
                                <option value="{{ $rux_ber->id }}"
                                    {{ old('ruxsatnoma_berilgan_ish_turi_id') == $rux_ber->id ? 'selected' : '' }}>
                                    {{ $rux_ber->name }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input class="form-control shaxarsozlik_umumiy_xajmi" type="number" step="any"
                            ...
                            value="{{ old('binoning_qurilish_hajmi') }}">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control avtoturargoh_xajmi" type="number" step="any"
                            ...
                            value="{{ old('binoning_avtoturargoh_qismi_hajmi') }}">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control qavat_xona_xajmi" type="number" step="any"
                            ...
                            value="{{ old('binoning_texnik_qavatlar_xonalar_hajmi') }}">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control umumiy_foydalanishdagi_xajmi" type="number" step="any"
                            ...
                            value="{{ old('turar_joy_binosining_umumiy_foydalanishdagi_qismi_hajmi') }}">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control form_select_cof form-select" name="ko_id" id="obyekt_turi">
                            ...
                            @foreach ($kos as $ko)
                                <option value="{{ $ko->id }}" {{ old('ko_id') == $ko->id ? 'selected' : '' }}
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control form_select_cof form-select" name="kj_id" id="obyekt_joylashuvi">
                            ...
                            @foreach ($kjs as $kj)
                                <option value="{{ $kj->id }}" {{ old('kj_id') == $kj->id ? 'selected' : '' }}
                    ...
                    <!-- Include Bootstrap and Google Maps API -->
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="text" name="loiyha_hajmi_haqida" id="loiyha_hajmi_haqida"
                            value="{{ old('loiyha_hajmi_haqida') }}">
                    </div>
                </div>
            </div>
        </div>
