            ...
            <ul class="pc-navbar">
                ...
                <li class="pc-item pc-hasmenu">
                    ...
                    <ul class="pc-submenu" style="display: block; box-sizing: border-box;">
                        ...
                        <li class="pc-item"><a class="pc-link"
                                href="{{ route('ruxsatnomaKimTamonidanIndex') }}">Ruxsatnoma kim tamonidan</a>
                        <li class="pc-item"><a class="pc-link" href="{{ route('subyektShakliIndex') }}">Subyekt
                                Shakli</a>
                        </li>

                        <li class="pc-item"><a class="pc-link" href="{{ route('xujjatTuriIndex') }}">Shaxsni tasdiqlovchi xujjat turi</a>
                        </li>
                        ...
                        <li class="pc-item"><a class="pc-link"
                                href="{{ route('xujjatBerilganJoyiIndex') }}">Xujjatning berilgan joyi</a>
                        </li>
